    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('navbar_order', models.PositiveSmallIntegerField(blank=True, help_text="Specify the order this page should appear on the site's navigation bar.", null=True, unique=True, verbose_name='navigation order')),
