    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(blank=True, choices=[('H', 'Home'), ('M', 'Mobile'), ('S', 'School'), ('W', 'Work'), ('O', 'Other')], max_length=1, verbose_name='label')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(blank=True, choices=[('H', 'Home'), ('S', 'School'), ('W', 'Work'), ('O', 'Other')], max_length=1, verbose_name='label')),
                ('address', models.EmailField(max_length=254, unique=True, verbose_name='email address')),
                ('is_published', models.BooleanField(default=True, help_text='Allow other members to see this address in the Troop directory.', verbose_name='published in directory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(blank=True, choices=[('H', 'Home'), ('S', 'School'), ('W', 'Work'), ('B', 'P.O. Box'), ('O', 'Other')], max_length=1, verbose_name='label')),
                ...
                ('is_published', models.BooleanField(default=True, help_text='Allow other members to see this address in the Troop directory.', verbose_name='published in the directory')),
                ('object_id', models.CharField(max_length=40)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
            ],
            options={
